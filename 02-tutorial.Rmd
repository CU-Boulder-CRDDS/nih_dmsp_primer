...
The goal of this primer was to provide a concise overview of practical resources that can help you to implement the NIH's new Data Management and Sharing Plan If you would like to discuss your needs in greater detail, please don't hesitate to reach out to CRDDS. 
...
* This [Guide to Social Science Data Preparation and Archiving](https://www.icpsr.umich.edu/files/deposit/dataprep.pdf) is written for a social science audience, but presents data management fundamentals that are of broader interest, and which are relevant to the NIH data requirements. 
