...
One of the main requirements of the NIH Data Management and Sharing Policy is that grant applicants complete a Data Management and Sharing (DMS) Plan, which now consists of an embedded online form that you will be prompted to complete in the course of submitting your proposal.
...
It is important to emphasize that when NIH refers to "sharing scientific data", the expectation is that data will be published in a dedicated third-party data repository; it is generally not acceptable to self-host data, or indicate that it will be shared upon request. For additional general information about data repositories, please see [Section 4](#repositories1). For information about repository services at CU Boulder, including CU Scholar (the campus's institutional repository, which can be used to publish your data in accordance with the NIH Data Management and Sharing Policy), please see [Section 5](#repositories2) below.

# Data Management Best Practices and Tools

Once you are awarded an NIH grant and your project gets underway, it is important to implement data management best practices, which will ultimately help (among other things) you to fulfill data deposit requirements at the end of the project in an efficient manner. To that end, the subsections below discuss some useful data management resources and strategies to consider.
...
The second explicit requirement associated with the new NIH Data Management and Sharing Policy (in addition to the Data Management and Sharing Plan requirement we discussed above) is that at the conclusion of your project, you must share your project data by publishing it in a publicly facing data repository in accordance with your DMS Plan commitments.
...
[CU Scholar](https://scholar.colorado.edu) is CU Boulder's institutional repository, and can be used to publish data in accordance with the NIH DMSP. CU Scholar is a popular venue for CU-affiliated researchers looking to publish their research data, since it is supported by CRDDS staff and resources who coordinate the publication process. In addition, CU Scholar has been certified by [CoreTrustSeal](https://www.coretrustseal.org), which is seen by grant reviewers and members of the scholarly communications community as a credible signal of a repository's overall quality. If you are interested in publishing your NIH project data on CU Scholar, the subsections below offer a brief overview of repository practices and policies.
...
The goal of this primer was to provide a concise overview of the NIH's Data Management and Sharing Policy, and general guidance on resources that will help you to fulfill Policy requirements. However, it is important to emphasize that every project is unique, and if you have specific questions about how to navigate the DMSP in the context of your own work, please contact CRDDS for a consultation. CRDDS staff are available at regularly scheduled consult hours during the academic ear (see the [CRDDS Events Page](https://www.colorado.edu/crdds/events) for more information), and by appointment (please email [crdds\@colorado.edu](mailto:crdds@colorado.edu)).
